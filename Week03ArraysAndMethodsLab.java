...
public class Week03ArraysAndMethodsLab {
	...
	public static void main(String[] args) {
		...
		System.out.println("\nQuestion 2:");	//**\n → a newline character. It tells Java to move the cursor to a new line before printing the rest. */
		...
		//System.out.println(array[6]); //Index 6 out of bounds for length 6
		...
		//		a. Analyze the difference between these two methods. 
        	// Can't put a void into a String
		//		b. What do you find? 
            //  There is a mismatch
		//		c. How are they different? 
		   //13 will do somwthing, 14 will return something
	...
	// Method 15:
	public static boolean doesStringLongerThanNumber (String string , int number) {
